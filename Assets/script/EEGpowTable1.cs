...
public class EEGpowTable1 : MonoBehaviour
{
    ...
    {
        A = Receiver.GetComponent<MindwaveReceiver>().Alpha;
        A = Mathf.Floor(A * 100f) / 100f;
        B = Receiver.GetComponent<MindwaveReceiver>().Beta;
        B = Mathf.Floor(B * 100f) / 100f;
        G = Receiver.GetComponent<MindwaveReceiver>().Gamma;
